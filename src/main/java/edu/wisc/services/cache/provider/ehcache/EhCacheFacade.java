 ...
 */
package edu.wisc.services.cache.provider.ehcache;
...
import edu.wisc.services.cache.provider.AbstractCacheProviderFacade;
import edu.wisc.services.cache.provider.CacheAccessException;
import edu.wisc.services.cache.provider.CacheModelValidator;
import edu.wisc.services.cache.provider.CacheNotFoundException;
import edu.wisc.services.cache.provider.ObjectCannotBeCachedException;
import edu.wisc.services.cache.provider.ReflectionCacheModelEditor;

/**
 * Implementation of
 * <code>{@link edu.wisc.services.cache.provider.CacheProviderFacade}</code>
 * that uses EHCache as the underlying cache implementation.
 *
 * @author Omar Irbouh
 * @author Alex Ruiz
 */
public abstract class EhCacheFacade extends AbstractCacheProviderFacade {
	...
	/**
	 * @see edu.wisc.services.cache.provider.CacheProviderFacade#getCachingModelEditor()
	 */
	...
	/**
	 * @see edu.wisc.services.cache.provider.CacheProviderFacade#getFlushingModelEditor()
	 */
