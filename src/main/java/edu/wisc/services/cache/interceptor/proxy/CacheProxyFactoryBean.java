...
package edu.wisc.services.cache.interceptor.proxy;
...
import edu.wisc.services.cache.interceptor.caching.CachingListener;
import edu.wisc.services.cache.interceptor.caching.CachingModelSourceAdvisor;
import edu.wisc.services.cache.interceptor.caching.NameMatchCachingInterceptor;
import edu.wisc.services.cache.interceptor.flush.FlushingModelSourceAdvisor;
import edu.wisc.services.cache.interceptor.flush.NameMatchFlushingInterceptor;
import edu.wisc.services.cache.key.CacheKeyGenerator;
import edu.wisc.services.cache.provider.CacheProviderFacade;
...
public final class CacheProxyFactoryBean extends ProxyConfig implements
   ...
   * <p>
   * Internally, a
   * <code>{@link edu.wisc.services.cache.interceptor.caching.NameMatchCachingModelSource}</code>
   * will be created from the given properties.
   * 
   * @param cachingModels
   *          the new caching models
   * 
   * @see edu.wisc.services.cache.interceptor.caching.NameMatchCachingModelSource
   */
   ...
   * <p>
   * Internally, a
   * <code>{@link edu.wisc.services.cache.interceptor.flush.NameMatchFlushingModelSource}</code>
   * will be created from the given properties.
   * 
   * @param flushingModels
   *          the new flushing models
   * 
   * @see edu.wisc.services.cache.interceptor.flush.NameMatchFlushingModelSource
   */
