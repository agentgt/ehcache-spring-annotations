 ...
 */
package edu.wisc.services.cache.config.ehcache;

import org.w3c.dom.Element;

import edu.wisc.services.cache.CachingModel;
import edu.wisc.services.cache.FlushingModel;
import edu.wisc.services.cache.config.AbstractCacheModelParser;
import edu.wisc.services.cache.config.CacheModelParser;
import edu.wisc.services.cache.provider.ehcache.EhCacheCachingModel;
import edu.wisc.services.cache.provider.ehcache.EhCacheFlushingModel;
