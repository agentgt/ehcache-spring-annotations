 ...
 * @version $Revision$
 */
public class DefaultTriggersRemoveInterceptor implements TriggersRemoveInterceptor {
    public static final DefaultTriggersRemoveInterceptor INSTANCE = new DefaultTriggersRemoveInterceptor();
